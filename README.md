...
* Check for macros to auto-complete.
 ...
 | 20. | Word1 word2 | |  `#  Buddhist lirerature. #` | `<w>Buddhist </w><w>lirerature.</w>` |   [Word](https://tei-c.org/release/doc/tei-p5-doc/en/html/ref-w.html) |
 ...
 | :ok: |check if there is bold text left| | | | |
