...
* Check for macros to auto-complete.
 ...
 | 18. heavy_check_mark: :ok:  | #sb{content} | | `#SB{A short affair}#` | `<s>A short affair</s>` |  [s-unit](https://tei-c.org/release/doc/tei-p5-doc/en/html/ref-s.html) |
 | 19. :ok: | last minus of a sentence| | | | |
